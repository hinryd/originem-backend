...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    funding_goal: Attribute.Decimal;
    amount_pledged: Attribute.Decimal;
    project_comments: Attribute.Relation<
      'api::project.project',
      'oneToMany',
...
export interface ApiProjectCommentProjectComment extends Schema.CollectionType {
  collectionName: 'project_comments';
  info: {
    singularName: 'project-comment';
    pluralName: 'project-comments';
    displayName: 'ProjectComment';
    description: '';
  };
  options: {
    draftAndPublish: true;
